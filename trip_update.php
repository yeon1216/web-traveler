...
function tripUpdate() {
    ...
    // 요청
    document.trip_update_form.submit();
...
<body>
    ...
    <br><br><br>
    <div class="container">
        <h2>나의 여행 남기기 수정</h2><br><br>
        <form name="trip_update_form" id="trip_update_form" method="post" action="trip_detail.php" enctype="multipart/form-data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img id="image_section" src="<?php echo $trip_representative_img; ?>" width="300px" height="300px" >
        ...
        <div class="mb-3">
                ...
                <input type="text" class="form-control" name="trip_title" id="trip_title" placeholder="제목을 입력해 주세요" maxlength="30" value="<?php echo $trip_title;?>">
            </div>
            <br><br>
            <div class="mb-3">
                <label for="content">내용</label>
                <textarea class="summernote" name="trip_content" id="summernote"><?php echo $trip_content;?></textarea>
            </div>
            <br><br>
            <label for="title">여행 유형</label>

            <select name="trip_type" id="trip_type" class="custom-select" onchange="trip_type_change(this);" value="<?php echo $trip_type_from_db;?>">
            <?php
            if($trip_type_from_db==1){
                ?>
                <option>여행 후기인가요? 여행 계획인가요?</option>
                ...
                <option value="2" selected>여행 계획</option>
                <?php
            }
            ?>
            ...
            <div class="mb-3">
                ...
                <span>시작 일&nbsp;</span>
                <input type="date" name="trip_start_day" id="trip_start_day" onchange="trip_start_day_change(this);" value="<?php echo $trip_start_day;?>">
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span>마지막 일&nbsp;</span>
                <input type="date" name="trip_finish_day" id="trip_finish_day" onchange="trip_finish_day_change(this);" value="<?php echo $trip_finish_day;?>">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                <p class="text-right">
            ...
            <br>
            <div class="mb-3">
                <label for="title">장소&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</label><span id="register_location" name="register_location"><?php echo $trip_location;?></span>

                <input maxlength="15" type="text" id="search_location" name="search_location" class="form-control" 
                    placeholder="장소를 입력해주세요" autocomplete="off"><br>
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td >
                                <?php
                                if($trip_route_arr=="등록 안함"){
                                    ?>
                                    <p id="route_arr">없 음</p>
                                    <?php
                                }else{
                                    ?>
                                    <p id="route_arr"><?php echo $trip_route_arr;?></p>
                                    <?php
                                }
                                ?>
            ...
            <input type="hidden" id="trip_location" name="trip_location" value="<?php echo $trip_location;?>" />
            <input type="hidden" id="trip_route_arr" name="trip_route_arr" value="<?php echo $trip_route_arr;?>" />
            <input type="hidden" id="trip_representative_img" name="trip_representative_img" value="<?php echo $trip_representative_img; ?>" />            
            <input type="hidden" id="trip_write_member_no" name="trip_write_member_no"
                value="<?php echo $login_member_no; ?>" />
            <input type="hidden" id="trip_update_action" name="trip_update_action" value="true" />
            <input type="hidden" id="trip_day_check" name="trip_day_check" value="1" />
        </form>
        <br><br><br><br>
        <div class="col text-right">
            <a href="#" class="btn btn btn-secondary" data-toggle="modal" data-target="#back-check-modal">취소</a>
            <a href="#" onclick="tripUpdate()" class="btn btn btn-secondary">여행 수정</a>
        </div>
    </div>
            ...
            <div class="modal-footer">
                ...
                <p>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                        onclick="window.location.replace('trip_detail.php?trip_no=<?php echo $trip_no;?>'); self.close();">네</button>
                </p>
            </div>
